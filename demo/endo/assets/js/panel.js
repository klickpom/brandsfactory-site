...
(function () {
  ...
  function renderBookings() {
    ...
    host.innerHTML = `
      ...
      <div class="filter-pills" role="group" aria-label="فلترة حسب الفرع">
        <button class="filter-pill" data-branch="all" aria-pressed="${activeBranch === 'all'}">كل الفروع</button>
        ${D.branches.map(br => {
      ...
      <div class="search-box">
        ...
        <input type="search" id="appt-search" placeholder="دوّر بالاسم أو الموبايل أو رقم الحجز أو الفرع…" aria-label="بحث في الحجوزات">
      </div>
  ...
  function renderTemplates() {
    ...
    host.innerHTML = `
      ...
      <p class="section-sub">أي تعديل هنا بيغيّر الرسالة اللي بتتبعت فوراً. المتغيرات المتاحة: {الاسم} {الرقم} {الخدمة} {الفرع} {اليوم} {الوقت} {الموبايل}</p>
